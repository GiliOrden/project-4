...
import EnglishKeyboardRows from './EnglishKeyboardRows';
...
class EnglishKeyboard extends Component {
    ...
    render() { 
        return (
            <div id="keyboard" >
                    <EnglishKeyboardRows isShift={this.state.isShift || this.state.isCapsLock} onClick={this.handleButtonClick}/>
